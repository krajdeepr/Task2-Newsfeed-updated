...
var data = [
  {
    image: "<div class='total-picture'><img class='total-picture' src='static/images/ndtv.jpg'></div>",
    heading: "NDTV",
  ...
  {
    image: "<div class='total-picture'><img class='total-picture' src='static/images/cnn.png'></div>",
    heading: "CNN",
    date: "Posted on 1 June,2019 Category: Category Two",
  ...
  {
    image: "<div class='total-picture'><img class='total-picture' src='static/images/mirror.png'></div>",
    heading: "MIRROR NOW",
  ...
  {
    image: "<div class='total-picture'><img class='total-picture' src='static/images/indiatoday.jpg'></div>",
    heading: "INDIA TODAY",
  ...
  {
    image: "<div class='total-picture'><img class='total-picture' src='static/images/zeenews.png'></div>",
    heading: "ZEE NEWS",
  ...
  {
    image: "<div class='total-picture'><img class='total-picture' src='static/images/timesnow.png'></div>",
    heading: "TIMES NOW",
  ...
  {
    image: "<div class='total-picture'><img class='total-picture' src='static/images/wion.jpg'></div>",
    heading: "WION",
  ...
  {
    image: "<div class='total-picture'><img class='total-picture' src='static/images/news9.png'></div>",
    heading: "NEWS9",
    date: "Posted on 30 Jan,2018 Category: Category Four",
  ...
  {
    image: "<div class='total-picture'><img class='total-picture' src='static/images/republictv.png'></div>",
    heading: "REPUBLIC TV",
    date: "Posted on 30 Jan,2018 Category: Category Four",
  ...
  {
    image: "<div class='total-picture'><img class='total-picture' src='static/images/newsx.png'></div>",
    heading: "NEWS X",
    date: "Posted on 30 Jan,2018 Category: Category Four",
